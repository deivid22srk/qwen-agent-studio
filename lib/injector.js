...
(function (global) {
  ...
  function ensurePanel() {
    ...
    panel.querySelector('#qa-pick').addEventListener('click', pickFolder);
    ...
    if (tab === 'status') {
      body.innerHTML = `
        ...
        <div style="margin-top:14px; font-size:12px; color:#8b8b8b; line-height:1.6">
          <p><b>Como usar:</b></p>
          <p>1. Selecione a pasta do seu projeto.</p>
          <p>2. Ligue o modo Agente.</p>
          <p>3. No chat do Qwen, peça tarefas como: "liste os arquivos", "leia src/index.js", "crie um arquivo hello.py", "encontre onde fica a função main".</p>
